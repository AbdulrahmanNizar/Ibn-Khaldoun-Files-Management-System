  ...
  async signup(
    ...
    try {
      ...
      const newUser = new this.userModel({
        ...
        school: requestInfo.userSchool,
        schoolPlace: requestInfo.userSchoolPlace,
        schoolBranch: requestInfo.userSchoolBranch,
        gradeSection: requestInfo.userGradeSection,
        sex: requestInfo.userSex,
        logged: true,
        subscription: false,
        subscriptionDate: '',
